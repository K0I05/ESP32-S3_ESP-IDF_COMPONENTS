...
# ESP-IDF Peripheral Components (ADC, I2C, OWB, SPI, UART)
...
- Texas Instruments INA226: component is synchronized with the esp-idf component registry and platform io library registry.
- Lite-On LTR390UV: component is synchronized with the esp-idf component registry and platform io library registry.
- Maxim-Integrated MAX30105: component is functional, to be synchronized.
...
- NXP Semiconductors PCT2075: component is synchronized with the esp-idf component registry and platform io library registry.
...
- OSRAM TCS3472: component is functional, to be synchronized.
